...
//create a class UntilZeroOrNegitive
public class UntilZeroOrNegitive
{
    public static void main(String[] args) 
	{
       ...
       //using a while loop to continue until the user enters 0
        while (inputUser > 0) 
		{
			...
			//to check if the user entered 0 or a negitive number using if statement
            if (inputUser == 0 || inputUser<0) 
			{
