...
public class StudentGrades
{
    public static void main(String[] args) {
        ...
        //create arrays to store marks, percentages, and grades of each students
        double[][] marks = new double[numberOfStudents][3]; 
        double[] percentages = new double[numberOfStudents];
        String[] grades = new String[numberOfStudents];

        //craete for loop to take input for marks of students in Physics, Chemistry, and Maths
		...
		//create for loop to print result
        for (int i = 0; i < numberOfStudents; i++) 
		{
